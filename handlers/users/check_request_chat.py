...
async def approver(req: types.ChatJoinRequest):
    ...
    chat_id = req.chat.id
    answer_text = "Assalomu alaykum <b>Inglizcha va O'zbekcha Tarjimon</b> ga xush kelibsiz!\n"
    answer_text += "Biror gap yozing Inglizcha yoki O'zbekchada Tarjimasini qaytaraman.\n"
